        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="bg-white p-6 rounded-lg shadow-lg">
              ...
              <p className="text-gray-700">
                Throughout highschool I competed in the FIRST Tech Challenge and FIRST Robotics compeition.  In 2022 I was fortunate to win Dean's List at the World Championship in Houston Texas. 
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-lg">
              <img
